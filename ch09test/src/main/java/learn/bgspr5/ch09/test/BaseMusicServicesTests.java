...
public abstract class BaseMusicServicesTests<
    ...
    void testFindArtistById() {
        ...
        A searched = musicService.getArtistById(artist.getId()).orElseThrow();
        assertNotNull(searched);
        assertEquals(artist.getName(), searched.getName());
        searched = musicService.getArtistById(getNonexistentId()).orElse(null);
        assertNull(searched);
    }
    ...
    void testFindSongById() {
        ...
        assertNotNull(song);
        S searched = musicService.getSongById(song.getId()).orElseThrow();
        assertNotNull(searched);
        assertEquals(song.getName(), searched.getName());
        searched = musicService.getSongById(getNonexistentId()).orElse(null);
        assertNull(searched);
    }
